...
from pluto_vsa.model import IQRecording, ModulationFamily, ModulationKind, SignalDescription
...
from pluto_vsa.channel import validate_analysis_channel_capture
...
class VSAWindow(QtWidgets.QMainWindow):
    ...
    def _build_configuration(self) -> None:
        ...
        from pluto_vsa.ui.setup_controls import ReceiverSetupControls, standardize_frontend
