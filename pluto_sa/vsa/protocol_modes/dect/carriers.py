"""Regional Classic DECT carrier plans kept separate from the PHY engine."""
...
def _plan(
    ...
    *,
    ...
    identifiers = (
        ...
        else tuple(first_channel + index for index in range(len(frequencies_mhz)))
    )
...
DECT_CARRIER_PLANS = (
    ...
    _plan(
        "etsi_ext_1935",
        "ETSI extended 1935–1960 MHz",
        tuple(1937.088 + 1.728 * channel for channel in range(14)),
        first_channel=10,
    ),
    _plan(
        "etsi_ext_2010",
        "ETSI extended 2010–2025 MHz",
